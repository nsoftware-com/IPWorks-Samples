...
begin
  ...
  begin
    ...
    ListStatus.Items.Add('Connected: ' + Description);
end;
...
begin
  ...
  try
    ...
    if TCPClient1.RemoteHost <> tHost.Text then
    begin
    ...
    begin
      if TCPClient1.Connected or bError then
        break;
...
procedure TFormEchoclient.TCPClient1DataIn(Sender: TObject; const Text: string;
  const TextB: TBytes; EOL: Boolean);
begin
  lTrack.Items.Add(Text + ': ' + IntToStr(GetTickCount - gStartTime) + ' milliseconds');
end;
