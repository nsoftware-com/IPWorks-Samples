...
begin
   ...
   begin
      ...
      if ComboBoxEncType.ItemIndex = 1 then
         EditTarget.Text := EditSource.Text + '.b64'
      else
      if ComboBoxEncType.ItemIndex = 2 then
         EditTarget.Text := EditSource.Text + '.q_p'
      else
      if ComboBoxEncType.ItemIndex = 3 then
         EditTarget.Text := EditSource.Text + '.url';
   end
   else
   if RadioGroupAction.ItemIndex = 1 then
   begin
...
procedure TFormNetcode.FormCreate(Sender: TObject);
begin
