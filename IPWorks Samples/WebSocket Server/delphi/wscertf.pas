...
type
  TFormWscert = class(TForm)
    ...
    procedure ipwCertMgr1CertList(Sender: TObject; CertEncoded: string;
      CertEncodedB: TBytes; const CertSubject, CertIssuer,
...
begin
  ...
  txtInfo.text := txtInfo.text + 'Issuer: ' + ipwCertMgr1.CertIssuer + #13#10;
  txtInfo.text := txtInfo.text + 'Subject: ' + ipwCertMgr1.CertSubject + #13#10;
  txtInfo.text := txtInfo.text + 'Version: ' + ipwCertMgr1.CertVersion + #13#10;
  txtInfo.text := txtInfo.text + 'Serial Number: ' + ipwCertMgr1.CertSerialNumber + #13#10;
  txtInfo.text := txtInfo.text + 'Signature Algorithm: ' + ipwCertMgr1.CertSignatureAlgorithm + #13#10;
  txtInfo.text := txtInfo.text + 'Effective Date: ' + ipwCertMgr1.CertEffectiveDate + #13#10;
  txtInfo.text := txtInfo.text + 'Expiration Date: ' + ipwCertMgr1.CertExpirationDate + #13#10;
  txtInfo.text := txtInfo.text + 'Public Key Algorithm: ' + ipwCertMgr1.CertPublicKeyAlgorithm + #13#10;
  txtInfo.text := txtInfo.text + 'Public Key Length: ' + inttostr(ipwCertMgr1.CertPublicKeyLength + #13#10;
  txtInfo.text := txtInfo.text + 'Public Key: ' + ipwCertMgr1.CertPublicKey + #13#10;
end;
